...
public class Server {
    ...
    private void run(String portNumber) {
        ...
        server.createContext("/person", new PersonHandler(db));
        server.createContext("/fill", new FillHandler(db));
        server.createContext("/event", new EventHandler(db));
    ...
    public static void main(String[] args) {
        ...
        RandomDataGenerator generator = RandomDataGenerator.getInstance();
        generator.ConvertDataToJson();
    }
}
